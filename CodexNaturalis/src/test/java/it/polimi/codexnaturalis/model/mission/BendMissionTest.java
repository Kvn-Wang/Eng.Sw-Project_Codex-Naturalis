...
class BendMissionTest {
    ...
    public void testAlgorithmCheck() throws PersonalizedException.InvalidPlaceCardRequirementException, PersonalizedException.InvalidPlacementException {
        ...
        testMap1.placeCard(middle-1,middle,secondTestCard,true);
        testMap1.placeCard(middle-2,middle,firstTestCard,true);
        testMap1.placeCard(middle-3,middle,firstTestCard,true);
        assertEquals(0,testBendMission.ruleAlgorithmCheck(testPlayer1));
        testMap1.placeCard(middle-3,middle+1,firstTestCard,true);
        ...
        testMap2.placeCard(middle+1,middle,secondTestCard,true);
        testMap2.placeCard(middle+2,middle,firstTestCard,true);
        testMap2.placeCard(middle+3,middle,firstTestCard,true);
        assertEquals(0,testBendMission1.ruleAlgorithmCheck(testPlayer2));
        testMap2.placeCard(middle+3,middle-1,firstTestCard,true);
        ...
        testMap3.placeCard(middle,middle-1,secondTestCard,true);
        ...
        testMap3.placeCard(middle+1,middle-3,firstTestCard,true);
        ...
        testMap4.placeCard(middle,middle+1,secondTestCard,true);
        ...
        testMap4.placeCard(middle-1,middle+3,firstTestCard,true);
